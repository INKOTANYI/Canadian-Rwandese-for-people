...
<body class="tm-enable-navbar-scrolltofixed tm-enable-navbar-always-visible-on-scroll">
    <div id="wrapper" class="clearfix">
        ...
        <div class="main-content-area">
                                ...
                                <div id="rev_slider_home" class="rev_slider fullwidthabanner" data-version="5.0.7">
                                    <ul>
                                        ...
                                        <li data-index="rs-2" data-transition="slidingoverlayhorizontal"
                                            ...
                                            <!-- LAYER NR. 4 -->
                                            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                                                id="slide-2-layer-4" data-x="['left','left','left','left']"
                                                data-hoffset="['53','53','53','30']"
                                                data-y="['top','top','top','top']"
                                                data-voffset="['410','290','260','250']"
                                                data-fontsize="['18','18','16','16']"
                                        ...
                                        <li data-index="rs-3" data-transition="slidingoverlayhorizontal"
                                            ...
                                            <!-- LAYER NR. 3 -->
                                            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                                                id="slide-3-layer-3" data-x="['left','left','left','left']"
                                                data-hoffset="['50','50','50','30']"
                                                data-y="['top','top','top','top']"
                                                data-voffset="['325','220','195','195']"
                                                data-fontsize="['16','16','14','13']"
                                            ...
                                            <!-- LAYER NR. 4 -->
                                            <div class="tp-caption tp-resizeme text-white rs-parallaxlevel-0"
                                                id="slide-3-layer-4" data-x="['left','left','left','left']"
                                                data-hoffset="['53','53','53','30']"
                                                data-y="['top','top','top','top']"
                                                data-voffset="['410','290','260','250']"
                                                data-fontsize="['18','18','16','16']"
                    ...
                    <div class="section-content">
                        <div class="row">
                            <div class="col-sm-12 text-center">
                                <h2 class="text-white">Welcome To Charitab Non-Profit &amp; NGO Ogranization</h2>
                                <p class="lead text-white">Help us support their work – make a donation Teenage Cancer
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row mb-80" data-tm-margin-top="-150px">
                                ...
                                <div
                                    ...
                                    <div class="icon-wrapper">
                                        <a class="icon icon-type-image icon-default">
                                            <img src="images/icon/charity1.png" alt="Image"></a>
                                    </div>
                                    <div class="icon-text">
                            ...
                            <div class="col-md-6 col-lg-4 mb-md-30">
                                <div
                                    ...
                                    <div class="icon-wrapper">
                                        <a class="icon icon-type-image  icon-default">
                                            <img src="images/icon/charity2.png" alt="Image"></a>
                                    </div>
                                    <div class="icon-text">
                                        <h3 class="icon-box-title ">
                                            Vision
                            ...
                            <div class="col-md-6 col-lg-4">
                                <div
                                    ...
                                    <div class="icon-wrapper">
                                        <a class="icon icon-type-image  icon-default">
                                            <img src="images/icon/charity3.png" alt="Image"></a>
                                    </div>
                                    <div class="icon-text">
                                        <h3 class="icon-box-title ">
                                            Mandate
            ...
            <!-- Our Goal -->
            <section class="" data-tm-bg-color="#ecf0f1">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="tm-sc tm-sc-section-title section-title section-title-style1 mb-10">
                                <div class="title-wrapper">
                                    <h2 class="title ">
                                        <span class="">Our</span>
                                        <span class="text-theme-colored1">Reach</span>
                                    </h2>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="tm-sc tm-sc-funfact funfact text-left">
                                        <h2 class="counter ">
                                            <span class="animate-number" data-value="18"
                                                data-animation-duration="1500">0</span><span
                                                class="counter-postfix">+</span>
                                        </h2>
                                ...
                                <div class="col-sm-4">
                                    <div class="tm-sc tm-sc-funfact funfact text-left">
                                        <h2 class="counter ">
                                            <span class="animate-number" data-value="456"
                                                data-animation-duration="1500">0</span><span
                                                class="counter-postfix">+</span>
                                        </h2>
                                ...
                                <div class="col-sm-4 mb-sm-30">
                                    <div class="tm-sc tm-sc-funfact funfact text-left">
                                        <h2 class="counter ">
                                            <span class="animate-number" data-value="1587"
                                                data-animation-duration="1500">0</span><span
                                                class="counter-postfix">+</span>
                                        </h2>
                                        <h5 class="title ">villages &amp; slums</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 mt-md-30">
                            <img class="" src="images/about/map.png" alt="">
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div class="container pb-80">
                    ...
                    <div class="section-content">
                        <div class="row">
                            <div class="col-sm-12">
                                <div
                                    class="tm-sc tm-sc-staff tm-sc-staff-carousel staff-style1-simple owl-dots-light-skin">
                                    <!-- Isotope Gallery Grid -->
                                    <div class="owl-carousel owl-theme tm-owl-carousel-4col" data-nav="true"
                                        data-dots="true" data-autoplay="true" data-loop="true"
                                        data-duration="6000" data-margin="30">
                                        <!-- the loop -->
                                                    ...
                                                    <div class="box-hover-effect">
                                                        ...
                                                        <div class="staff-content">
                                                            ...
                                                            <div class="staff-btn">
                                                                <div class="btn-view-details">
                                                                    <a href="#"
                                                                        class="btn - btn-theme-colored1 - btn-sm">View
                                                                        Details</a>
                                                                </div>
                                                                <div class="clearfix"></div>
                                                            </div>
