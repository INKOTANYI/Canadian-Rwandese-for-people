                    ...
                    <div class="section-content">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h2 class="title text-white">Upcoming Events</h2>
                ...
                <div class="container pb-60">
                    <div class="section-content">
                        <div class="row">
                            <div class="col-sm-12">
                                <div
                                    class="tm-sc tm-sc-tribe-events tm-sc-tribe-events-carousel owl-dots-light-skin  ">
                                    <!-- Isotope Gallery Grid -->
                                    <div id="events-holder-472306" class="owl-carousel owl-theme tm-owl-carousel-2col"
                                            ...
                                            <div id="post-282"
                                                ...
                                                <div class="event-content">
                                                    ...
                                                    <div class="event-excerpt">
                                                        <p>Who&#8217;s that then? Shh! Knights, I bid you welcome to
                                                            your new home.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tm-carousel-item family-fun">
                                            <div id="post-284"
                                                ...
                                                <div class="event-content">
                                                    <h5 class="event-title">
                                                        <a href="#" title="Farmer’s Market">Farmer’s Market</a>
                                                    </h5>
                                                    <div class="event-meta">
                                                        <div class="each-meta event-schedule-details">
                                        ...
                                        <div class="item-inner">
                                            <div
                                                ...
                                                <div class="tm-sc tm-sc-button  btn-circle">
                                                    <a href="" target="_self"
                                                        class="btn btn-outline-light btn-outline">Join Us</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
