                    ...
                    <div class="section-content">
                        <div class="row">
                            <div class="col-sm-12 text-center">
                                <h2 class="text-white">Welcome ToCanadian Rwandese Foundation of People With
                                    Disabilities in Alberta</h2>
                            ...
                            <div class="col-md-6 col-lg-4 mb-md-30">
                                <div
                                    ...
                                    <div class="icon-text">
                                        ...
                                        <div class="content">
                                            <p>To support and Ancourage Individuals With Disabilities and Their Families
                                                to Achieve their full potential as members of their comminity</p>
                                        </div>
                                    </div>
    ...
    <section>
        <div class="container pb-80">
            ...
            <div class="section-content">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="tm-sc tm-sc-staff tm-sc-staff-carousel staff-style1-simple owl-dots-light-skin">
                            <!-- Isotope Gallery Grid -->
                            <div class="owl-carousel owl-theme tm-owl-carousel-4col" data-nav="true" data-dots="true"
                                data-autoplay="true" data-loop="true" data-duration="6000" data-margin="30">
                                <!-- the loop -->
                                        ...
                                        <div class="staff-inner">
                                            <div class="box-hover-effect">
                                                <div class="effect-wrapper">
                                                    <div class="thumb">
                                                        <img width="550" height="550" src="images/team/1.jpg"
                                                            alt="" />
                                                    </div>
                                    ...
                                    <div class="tm-staff staff-items type-staff-items">
                                        <div class="staff-inner">
                                            <div class="box-hover-effect">
                                                <div class="effect-wrapper">
                                                    <div class="thumb">
                                                        <img width="550" height="550" src="images/team/2.jpg"
                                                            alt="" />
                                                    </div>
                                                    <div class="overlay-shade shade-white"></div>
                                                    <div class="icons-holder icons-holder-middle">
                                    ...
                                    <div class="tm-staff staff-items type-staff-items">
                                        <div class="staff-inner">
                                            <div class="box-hover-effect">
                                                <div class="effect-wrapper">
                                                    <div class="thumb">
                                                        <img width="550" height="550" src="images/team/3.jpg"
                                                            alt="" />
                                                    </div>
                                                    <div class="overlay-shade shade-white"></div>
                                                    <div class="icons-holder icons-holder-middle">
                                    ...
                                    <div class="tm-staff staff-items type-staff-items">
                                        <div class="staff-inner">
                                            <div class="box-hover-effect">
                                                <div class="effect-wrapper">
                                                    <div class="thumb">
                                                        <img width="550" height="550" src="images/team/4.jpg"
                                                            alt="" />
                                                    </div>
                                                    <div class="overlay-shade shade-white"></div>
                                                    <div class="icons-holder icons-holder-middle">
